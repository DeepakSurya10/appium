 ...
 * @returns {import('../driver').BaseDriverBase<import('@appium/types').TimeoutCommands & import('@appium/types').EventCommands & import('@appium/types').FindCommands>}
 */
export function FindMixin (Base) {
  return class FindCommands extends Base {
    /**
     *
